...
const routes: Routes = [
  {
    path: 'faq', component: FaqComponent, data: {
      ...
      descrption: ' Explore our FAQ section to uncover comprehensive property queries & solutions in Oman to effortlessly rent, buy, or sell properties with Mumtalikati.'
    }
  },
  {
  ...
  },
  {
    path: 'contactus', component: ContactusComponent, data: {
      ...
      descrption: 'Reach out to Mumtalikati for expert insights and assistance in achieving your real estate goals. We\'re here to help you buy, rent, or sell properties in Oman.',
    }
  },
  {
    path: 'propertyfulldisplay', component: PropertyfulldisplayComponent, data: {
      title: 'Find Your Ideal Rental Property in Oman with Mumtalikati ',
      descrption: 'Looking for a rental property in Oman? Mumtalikati has you covered. Explore our extensive listings and find your ideal home. Begin your search now.',
    }
  },
  {
  ...
  },
  {
    ...
    data: {
      ...
      descrption: 'Explore a wide range of rental, buying, and selling options in Oman with Mumtalikati. Our real estate listing portal simplifies your property search.'
    }
  },
  { path: '**', component: HomeComponent }
